...
public class NumberToCNUtil {
	...
	private static final String[] CN_UPPER_MONETRAY_UNIT = new String[] { "分", "角", "元", "拾", "佰", "仟", "万", "拾", "佰",
			"仟", "亿", "拾", "佰", "仟", "兆", "拾", "佰", "仟" };
	...
	public static void main(String[] args) {
		BigDecimal bigDecimal = new BigDecimal(131135.0D);
		String string = number2CNMontrayUnit(bigDecimal);
